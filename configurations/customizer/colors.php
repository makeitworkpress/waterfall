    ...
    'sections'      => array(
       ...
       array(
        ...
        array(
            ...
            'fields'    => array(                    
                array(
                    'selector'           => array( 'selector' => '.main-header', 'property' => 'background-color' ),
                    'default'       => '',
                    'id'            => 'title_section',
                ...
                array(
                    'selector'           => array( 'selector' => '.main-content', 'property' => 'background-color' ),
                    'default'       => '',
                    'id'            => 'content_main',
                ...
                array(
                    'selector'           => array( 'selector' => '.main-sidebar', 'property' => 'background-color' ),
                    'default'       => '',
                ...
                array(
                    'selector'           => array( 'selector' => '.main-related', 'property' => 'background-color' ),
                    'default'       => '',
                    'id'            => 'content_related',
                ...
                array(
                    'selector'           => array( 'selector' => '.main-footer', 'property' => 'background-color' ),
                    'default'       => '',
                    'id'            => 'content_footer',
        ...
        array(
            ...
            'fields'    => array(                    
                array(
                    'selector'           => array( 'selector' => '.molecule-footer-sidebars', 'property' => 'background-color' ),
                    'default'       => '',
                ...
                array(
                    'selector'           => array( 'selector' => '.molecule-footer-socket', 'property' => 'background-color' ),
                    'default'       => '',
        ...
        array(
            ...
            'fields'    => array(                      
                ...
                array(
                    'selector'           => array( 
                        'selector' => 'input[type=\'submit\']:hover, input[type=\'submit\'].button:hover, .elementor-element.elementor-button-danger .elementor-button:hover, .woocommerce input.button.alt:hover, .header .atom-cart input.button.alt:hover, .woocommerce button.button.alt:hover, .header .atom-cart button.button.alt:hover, .woocommerce a.button.alt:hover, .header .atom-cart a.button.alt:hover, .header .atom-cart a.button.checkout:hover, .atom-button.components-default-background:hover', 
                        'property' => 'background-color' 
                    ),
                    'default'       => '',
